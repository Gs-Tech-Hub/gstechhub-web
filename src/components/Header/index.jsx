...
export default function Header({ logoUrl, colorVariant, cart, actionBtnText, actionBtnUrl }) {
            ...
            <div className="container">
               <div className="cs_main_header_in">
                           ...
                           {/* <li className="menu-item-has-children">
                              ...
                              <DropDown>
                                 <ul>
                                    ...
                                    <li>
                                       <Link to="portfolio/portfolio-details">Portfolio Details</Link>
                                    </li>
                                    <li>
                  ...
                  <div className="cs_main_header_right">
                     ...
                     <Link to={actionBtnUrl} className={`cs_btn cs_style_1  ${colorVariant ? "cs_btn_white" : ""}`}>
                        {actionBtnText}
                     </Link>
                  </div>
               </div>
