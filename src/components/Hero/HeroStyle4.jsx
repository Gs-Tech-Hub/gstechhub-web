...
export default function HeroStyle4({ title, subTitle, videoSrc, bgUrl, thumbnailSrc }) {
   return (
      <section
      ...
      >
         ...
         <div className="cs_hero_shape">
            <svg width={458} height={475} viewBox="0 0 458 475" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path
                  opacity="0.3"
