...
export default function DigitalAgencyPage({ darkMode }) {
   ...
   //    const posts = await api.fetchData(
   //       "api/posts?api/posts?filters[is_featured][$eq]=true&fields[0]=title&fields[1]=createdAt&populate[coverphoto][fields][0]=name&populate[coverphoto][fields][1]=url",
   //    );
   //    const testimonial = await api.fetchData(
   //       "api/testimonials?fields[0]=Name&fields[1]=Description&fields[2]=CompanyPosition",
   //    );
   //    const portfolio = await api.fetchData(
   //       "api/portfolios?populate[CoverPhoto][fields][0]=name&populate[CoverPhoto][fields][1]=url&fields[0]=Title&fields[1]=miniTitle&fields[2]=SubTitle&fields[3]=urlSlug",
   //    );
